...
Files: macbook-16.glb [639.28KB] > C:\Users\dkkim1\Downloads\mulgko\ip1\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // change color only if the part name is Not noChange
